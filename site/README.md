...
- **Grid** — one card per beer: cover photo, brewery, name, type · ABV, a rating pill, and a photo-count badge when there's more than one shot. Thumbnails are a uniform 3:4 portrait crop.
